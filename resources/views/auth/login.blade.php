...
@section('content')
    <form action="{{ route('login.perform') }}" method="POST" class="m-auto border rounded-md p-4 w-80" >
        @csrf
        <div class="flex flex-col justify-center mx-auto mb-3 gap-4">
            <img class="w-40 h-auto m-auto" src="{{ asset('logo.png') }}" alt="">
