...
@section('content')
    <div class="bg-white px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12 flex-grow">
        <div class="w-full lg:w-1/2">
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400">Oops! Halaman yang Anda cari tidak ditemukan.</p>
        ...
        <div class="relative w-full mt-12 lg:w-1/2 lg:mt-0">
            <div class="w-auto lg:w-full max-w-lg lg:mx-auto">
                <svg xmlns="http://www.w3.org/2000/svg" width="auto" height="auto" viewBox="0 0 514 164" fill="none">
                    ...
                    <line x1="-8.74228e-08" y1="163" x2="513" y2="163" stroke="#667085"
                        stroke-width="2" />
                </svg>
            </div>
        </div>
